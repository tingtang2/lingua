...
```
use the provided script to download and prepare data from huggingface (among `fineweb_edu`, `fineweb_edu_10bt`, `dclm_baseline_1.0`, or `c4_en_10pct`).
...
```
For an approximate 10% English C4 subset, use:
```bash
python setup/download_prepare_hf_data.py c4_en_10pct <MEMORY> --data_dir ./data --seed 42 --nchunks <NCHUNKS> --shuffle_tmp_dir /scratch/$USER/terashuf_tmp
```
