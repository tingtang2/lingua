...
python /usr/workspace/mcleish1/llnl-tools/launch_tuo.py \
    ...
    --output_dir=/usr/workspace/mcleish1/loss-spikes-project/lingua/runs \
    --rocm_version=6.4.2 \
    --run_name=7b_loss_spike_3_grad_accum_8_lr_9e_3_cycle_length_20_wd_1e_4_warmup_64 \
    --nodes=4 \
    --minutes=1440 \
    --repetitions=1 \
    --launch_once_per_node=true \
    --pass_run_name=false \
    --custom_invocation='bash sean_shells/launcher_multi_node.sh apps/main/configs/llama_7B_base_spike.yaml optim.warmup=64' --bank=guard
...
python /usr/workspace/mcleish1/llnl-tools/launch_tuo.py \
    ...
    --output_dir=/usr/workspace/mcleish1/loss-spikes-project/lingua/runs \
    --rocm_version=6.4.2 \
    --run_name=7b_loss_spike_3_grad_accum_8_lr_9e_3_cycle_length_20_wd_1e_4_warmup_128 \
    --nodes=4 \
    --minutes=1440 \
    --repetitions=1 \
    --launch_once_per_node=true \
    --pass_run_name=false \
    --custom_invocation='bash sean_shells/launcher_multi_node.sh apps/main/configs/llama_7B_base_spike.yaml optim.warmup=128' --bank=guard
...
python /usr/workspace/mcleish1/llnl-tools/launch_tuo.py \
    ...
    --output_dir=/usr/workspace/mcleish1/loss-spikes-project/lingua/runs \
    --rocm_version=6.4.2 \
    --run_name=7b_loss_spike_3_grad_accum_16_lr_9e_3_cycle_length_20_wd_1e_4_warmup_95 \
    --nodes=16 \
    --minutes=1440 \
    --repetitions=1 \
    --launch_once_per_node=true \
...
python /usr/workspace/mcleish1/llnl-tools/launch_tuo.py \
    ...
    --output_dir=/usr/workspace/mcleish1/loss-spikes-project/lingua/runs \
    --rocm_version=6.4.2 \
    --run_name=7b_loss_spike_3_grad_accum_8_lr_3e_4_cycle_length_20_wd_1e_1_warmup_128 \
    --nodes=4 \
    --minutes=1440 \
    --repetitions=1 \
    --launch_once_per_node=true \
...
python /usr/workspace/mcleish1/llnl-tools/launch_tuo.py \
    ...
    --output_dir=/usr/workspace/mcleish1/loss-spikes-project/lingua/runs \
    --rocm_version=6.4.2 \
    --run_name=7b_loss_spike_3_grad_accum_8_lr_3e_4_cycle_length_20_wd_1e_1_warmup_128_beta_2_99 \
    --nodes=4 \
    --minutes=1440 \
    --repetitions=1 \
    --launch_once_per_node=true \
